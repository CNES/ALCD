    ...
    <rasterrenderer opacity="1" alphaBand="0" classificationMax="6" classificationMinMaxOrigin="CumulativeCutFullExtentEstimated" band="1" classificationMin="2" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0">
          ...
          <item alpha="255" value="2" label="low clouds" color="#d2d2d2"/>
          <item alpha="255" value="3" label="high clouds" color="#ff7bb8"/>
          <item alpha="255" value="4" label="clouds shadows" color="#0a0a0a"/>
          <item alpha="255" value="5" label="land" color="#009738"/>
